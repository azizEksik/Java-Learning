...
public class C01_StringBuilder {
    public static void main(String[] args) {
        ...
        System.out.println(sb1.capacity()); // 34 // 34 = 2 * eski capacity + 2

        System.out.println(sb1.length()); // 18

        sb1.append(" javayi çok sever, sabah aksam Java calisir.");

        System.out.println(sb1.capacity()); // 70 // 70 = 2 * 34 + 2
        ...
        System.out.println(sb3); // 28030524226 : Tc No

        System.out.println(sb3.capacity()); // 24 // 11*2+2 =24
        ...
        System.out.println(sb3); // 28030524226 : Tc No Candir
