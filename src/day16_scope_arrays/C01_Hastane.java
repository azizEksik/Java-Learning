...
public class C01_Hastane {
    public static void main(String[] args) {
        ...
        System.out.println(dok1); // referansını yazdırır // day16_scope_arrays.ADoktor@58ceff1
        ...
        // static variable'lar için tavsiye edilen erişim yöntemi
        // classIsmi.staticUyeIsmi şeklinde yazımdır
