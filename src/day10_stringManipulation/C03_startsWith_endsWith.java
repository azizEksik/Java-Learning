...
public class C03_startsWith_endsWith {
    public static void main(String[] args) {
        ...
        // "ile başlar" methodu  starsWith'tir. ile başlıyorsa true, başlamıyorsa false
        ...
        System.out.println(str.endsWith("Java harika")); //ture

        System.out.println(str.endsWith("")); // true

        System.out.println(str.endsWith(str.substring(str.length() - 1))); //true

        // "bunla mı bitiyor" metodu endsWith'tir. bunla bitiyorsa true, bitmiyorsa false
